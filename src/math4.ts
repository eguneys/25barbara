...
export class Vec3 {
  ...
  get normalize() {
    ...
    return new Vec3(this.x, this.y, this.z).scale(1/this.length)
  }

  get clone() { return Vec3.make(this.x, this.y, this.z) }
...
export class Mat4 {
  ...
  get clone() { return new Mat4(this.out.slice(0)) }
